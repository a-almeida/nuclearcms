    ...
    protected function _find_view($file)
    {
        ...
        if ( $current_module !== $this->_module )
        {
            ...
            $new_locations = array(
            	...
            	APPPATH.'../../'.NUCLEARCORE.'/modules/' . $current_module .'/views/',
				APPPATH.'../../'.NUCLEARCORE.'/plugins/' . $current_module .'/views/',            		
    ...
    */
    ...
    protected function _update_theme_paths()
    {
        ...
        $this->_template_locations = array(
			...
			$this->CI->config->item('smarty.theme_path') . $this->_theme_name . '/',
			APPPATH.'../../'.NUCLEARCORE.'/modules/' . $this->_module .'/views/',
			APPPATH.'../../'.NUCLEARCORE.'/plugins/' . $this->_module .'/views/',
        	APPPATH.'views/' . $this->_theme_name .'/'
