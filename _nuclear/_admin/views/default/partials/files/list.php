	          ...
	          <div class="row">
				...
				<div id="fileTreeDemo_1" class="demo"></div>
	               ...
	               <h4><b>Directory </b></b><span id="directory"></span></h4>
				       <form id="upload" method="post" action="<?=PUBLICPATH;?>p/files/uploadimages/" enctype="multipart/form-data" class="col-sm-3">
...
function removeimage(str,esta)
{
	    ...
	    if (r == true) {
	    $.post( "<?=PUBLICPATH?>p/files/images/remove/"+str, { 'delete':  str  }, function( data ) {
				$(esta).parent().remove();
				 //alert(data);
				});
